                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(
                        ...
                        child: Icon(Icons.assignment_turned_in, color: rosaVibrante),
                      ),
                      title: Text(
                        ata.titulo, 
                      ...
                      onTap: () {
                        // Ao clicar, vai para a tela ler_ata_screen ver a lista de nomes!
                        Navigator.push(
                          context, 
                          MaterialPageRoute(builder: (_) => LerAtaScreen(ata: ata))
                        );
                      },
                    ),
                  );
